import 'package:app_jualan/screens/write_review_screen.dart';
      ...
      child: Container(
        ...
        child: Row(
          children: [
            ...
            SizedBox(width: 4),
            Text(count, style: TextStyle(color: AppTheme.textSecondary)),
          ],
        ),
      ),
    );
                ...
                return Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 8),
                      Text(
                        "the t-shirt is exactly what i was looking for. the material is soft and comfortable, and the size fits perfectly. I would definitely recomended this product to others",
                        style: TextStyle(
                          color: AppTheme.textSecondary,
                          height: 1.5,
                        ),
