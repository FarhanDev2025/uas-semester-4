  ...
  Widget build(BuildContext context) {
    return Scaffold(
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              SizedBox(height: 8),
                              Text(
                                "Share Photos of the product to help other buyers",
                                style: TextStyle(color: AppTheme.textSecondary),
                              ),
                              SizedBox(height: 16),
                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                SizedBox(height: 12),
                                _buildGuidelineItem('Focus on the product and your experience'),
                                _buildGuidelineItem('Be homes and specific in your feedback'),
                                _buildGuidelineItem('Keep it friendly and respectful'),
                                _buildGuidelineItem('Photos should be clear and relevant'),
                              ],
                            ),
                          ),
                          SizedBox(height: 100),
      ...
      bottomSheet: Container(
        ...
        child: SafeArea(child: GradientButton(text: "Submit Review", onPressed: (){},
        ),
        ),
      ),
    );
