...
class _SearchFilterScreenState extends State<SearchFilterScreen> {
  ...
  final activeFilters = ['Rp0 -1.000.000', 'Brand: A', 'Size: M', 'In Stock'];

  final brands = ['Brand A', 'Brand B', 'Brand C', 'Brand D', 'Brand E'];
          ...
          Stack(
            children: [
              ...
              Positioned(
                ...
                child: IconButton(
                  onPressed: () {},
                  icon: Icon(Icons.favorite_border, color: AppTheme.error),
                ),
              ),
              Positioned(
                top: 8,
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              Wrap(
                                ...
                                children:
                                    sizes.map((Size) {
                                      final isSelected = _selectedSizes
                                          .contains(Size);
                                      return FilterChip(
                                        selected: isSelected,
                                        label: Text(Size),
