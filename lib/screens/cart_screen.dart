...
class CartScreen extends StatelessWidget {
  ...
  Widget _buildSummaryRow(String lable, String value, {bool isTotal = false}) {
    return Padding(
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 16),
                      _buildSummaryRow("Subtotal", 'Rp.897.000'),
                      _buildSummaryRow("Shopping", 'Rp.10.000'),
                      _buildSummaryRow("Tax", 'Rp.25.999'),
                      Divider(height: 24),
                      _buildSummaryRow("Total", 'Rp.984.997', isTotal: true),
                    ],
                  ),
                ),
                SizedBox(height: 100),
